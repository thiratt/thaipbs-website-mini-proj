...
const HeroSection = forwardRef<HTMLElement, { nextPage?: () => void }>(({ nextPage }, ref) => {
	return (
		<section ref={ref} className="relative min-h-svh flex flex-col overflow-hidden bg-[#171714] text-white">
			...
			<div className="relative z-10 flex min-h-svh items-center px-4 py-24 lg:px-8">
				<div className="w-full">
					...
					>
						...
						<h1>
							<span className="block text-[clamp(6.5rem,18vw,13rem)] leading-[0.7] text-[#f18717]">
								แล้ง
							</span>
			...
			>
				...
				<div className="relative h-2 overflow-hidden bg-white/20 rounded-full">
					<motion.div
						...
						className="absolute inset-y-0 left-0 w-[9.1%] origin-left bg-[#f18717]"
					/>
				</div>
