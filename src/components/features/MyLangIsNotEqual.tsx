	...
	return (
		<section ref={ref} className="relative overflow-clip bg-[#171714] text-white">
			<div className="pointer-events-none absolute inset-0">
				<div className="absolute right-[-18vw] top-[8%] size-[54vw] rounded-full bg-[#f18717]/6 blur-[200px]" />
				<div className="absolute left-[-22vw] top-[58%] size-[48vw] rounded-full bg-[#f18717]/4 blur-[210px]" />
			...
			<div className="relative mx-auto px-4 pb-24 pt-24 sm:px-8 md:pb-32 md:pt-32 lg:px-10 lg:pb-40">
				...
				>
					<div className="flex items-center gap-3 text-[0.66rem] font-black uppercase tracking-[0.22em] text-[#f18717] sm:text-xs">
						...
						<span>Heat index · Human impact</span>
					</div>
					...
					<div className="mt-16 grid items-end gap-10 lg:grid-cols-[1.12fr_0.88fr] lg:gap-16 xl:gap-24">
						<h2 className="text-[clamp(4.5rem,9vw,9.5rem)] font-black leading-[0.78] tracking-[-0.075em]">
							...
							<span className="mt-5 block text-[#f18717]">แล้งไม่เท่ากัน</span>
						</h2>
						...
						>
							<div className="border-y border-white/12 py-6">
								...
								<p className="mt-4 max-w-sm text-[clamp(2rem,3.8vw,4rem)] font-black leading-[1.2] tracking-tighter">
									ยิ่งร้อน
									<span className="block text-[#f18717]">ยิ่งเสี่ยง</span>
								</p>
